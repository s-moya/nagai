...
<form method="post" action="<?php echo $controller->getRequestUrl(); ?>">
    ...
    <table class="form-table">
        ...
        <tr class="form-field form-required">
            ...
            <td>
                <?php //2024-11-22 ?>
                <input size="40" value="<?php echo $userGroup->getName() ? htmlentities($userGroup->getName()) : ''; ?>"
        ...
        <tr class="form-field form-required">
            ...
            <td>
                <?php //2024-11-22 ?>
                <input size="40" value="<?php echo $userGroup->getDescription() ? htmlentities($userGroup->getDescription()) : ''; ?>"
        ...
        <tr class="form-field form-required">
            ...
            <?php // 2024-11-22 ?>
            <td><input size="40" value="<?php echo $userGroup->getIpRange() ? htmlentities($userGroup->getIpRange()) : ''; ?>"
