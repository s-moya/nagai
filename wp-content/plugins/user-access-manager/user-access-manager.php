...
add_action( 'plugins_loaded', 'user_access_manager_load_textdomain');
function user_access_manager_load_textdomain()
{
    //Load language

    $basePath = __DIR__.DIRECTORY_SEPARATOR;
    include $basePath.'includes'.DIRECTORY_SEPARATOR.'language.php';
...
add_action('wp_loaded', 'user_access_manager_init' );
function user_access_manager_init(){
